        ...
        <div className="pb-[30px] px-[20px] md:px-[100px] lg:px-[200px] md:flex gap-[50px]">
          ...
          >
            ...
            <span>
              ...
              <div className="mt-5 md:mt-5 flex gap-3">
                {/* Hire Me Button */}
                <Link
            ...
            <div className="mt-5 justify-evenly text-justify">
              <p className="text-gray-600 dark:text-gray-300">
                My journey started with curiosity—asking “why” and “how” more than “what,” which led me to software engineering. In college, I led C++ sessions, managed RCC Techz&apos;s Magazine, and performed on stage, learning to blend structure with creativity. I dived into MERN Stack and Next.js development, optimizing features, and improving systems by automating 95% of test execution cases. I thrive on mentoring, collaborating, and solving real-world problems. Lately, AI and Machine Learning excite me, and my mission is to create dynamic solutions that impact users, teams, and the world around me.
              </p>
            </div>
          </div>
        </div>
